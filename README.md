...
Adafruit_GPS.h e Adafruit_GPS.cpp o pure al file NMEA_parse.cpp della nuova library. Volendo anche senza, con l'update "Arduvario_ESP32_1.ino" del codice senza modifica della library del GPS, inoltre è stato disattivato l'invio delle stringhe GPS tramite WiFi e Bluetooth perchè quasi inutili considerato che quasi tutti i device sono provvisti di GPS
